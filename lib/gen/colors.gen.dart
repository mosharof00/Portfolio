...
class ColorName {
  ...
  /// Color: #212121
  static const Color appTextBlackColor = Color(0xFF212121);

  /// Color: #5E5E5E
  static const Color appTextGrayColor = Color(0xFF5E5E5E);

  /// Color: #3DC963
  static const Color appTextGreenOpacityColor = Color(0xFF3DC963);

  /// Color: #B80808
  static const Color appTextRedColor = Color(0xFFB80808);

  /// Color: #FA0A0A
  static const Color appTextRedOpacityColor = Color(0xFFFA0A0A);

  /// Color: #FBBC05
  static const Color appTextYelloColor = Color(0xFFFBBC05);
  ...
  /// Color: #B80808
  static const Color onPrimary = Color(0xFFB80808);

  /// Color: #06F8F4
  static const Color pest = Color(0xFF06F8F4);

  /// Color: #B80808
  static const Color primaryColor = Color(0xFFB80808);
  ...
  /// Color: #444444
  static const Color uploadColor = Color(0xFF444444);

  /// Color: #FFFFFF
  static const Color white = Color(0xFFFFFFFF);

  /// Color: #FFECE7
  static const Color whitePaste = Color(0xFFFFECE7);
